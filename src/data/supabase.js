...
// Single shared client. This module (and repository.js) are the ONLY files that
...
// Subscribe to auth changes; cb receives the user (or null). Returns the
// supabase subscription object ({ data: { subscription } }).
